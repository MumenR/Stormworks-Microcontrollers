    ...
    if launch then
        ...
        elseif step3 == false then
            if active_radar and target_distance < 500 and active_radar_lock_on == 1 then
                destination_x, destination_y, destination_z = cal_collision_location(radar_x, radar_y, radar_z, radar_vx, radar_vy, radar_vz, world_x, world_y, world_z, missile_v, target_distance, 0)
            else
